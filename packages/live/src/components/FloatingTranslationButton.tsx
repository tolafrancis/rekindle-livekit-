...
import { Languages, Check, Volume2, Copy, Square, Plus, Loader2 } from 'lucide-react';
    ...
    <Popover>
      <PopoverTrigger asChild>
        <button
          ...
          className={`flex h-10 items-center gap-1.5 rounded-full shadow-lg backdrop-blur-sm px-3 transition-colors ${
            currentLanguage ? 'bg-indigo-600 text-white hover:bg-indigo-700' : 'bg-gray-900/70 text-white hover:bg-gray-800/80'
          }`}
        >
      ...
      <PopoverContent align="center" className="w-72 p-2">
        ...
        <p className="text-[10px] text-gray-400 px-2.5 pt-1.5">
          "Original" mutes the translation and restores the room's normal audio.
        </p>
      </PopoverContent>
    </Popover>
  );
