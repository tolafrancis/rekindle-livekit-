        ...
        <section id="pricing" style={{ background: '#fdf9f3', padding: '100px 0' }}>
          <div style={{ maxWidth: 1180, margin: '0 auto', padding: '0 24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(260px, 100%), 1fr))', gap: 20, marginTop: 56, alignItems: 'start' }}>
              {[
                { name: t('landing', 'tierFreeName', "Free"),               price: '$0',      unit: t('landing', 'tierFreeUnit', "forever"),        desc: t('landing', 'tierFreeDesc', "Everything you need for your daily walk"),      popular: false, cta: t('landing', 'tierFreeCta', "Get Started"),          features: [t('landing', 'tierFree1', "Daily devotionals with audio"),t('landing', 'tierFree2', "Offline access to devotionals"),t('landing', 'tierFree3', "Community prayer wall"),t('landing', 'tierFree4', "Join live channels"),t('landing', 'tierFree8', "Free Ministry Meetings — 4/month, up to 10 participants"),t('landing', 'tierFree5', "GraceCounsel AI companion"),t('landing', 'tierFree6', "Prayer streaks & Scripture memory"),t('landing', 'tierFree7', "Book a counsellor")] },
