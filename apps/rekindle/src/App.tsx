            ...
            <LanguageProvider>
              <GlobalAudioProvider>
                ...
                <BrowserRouter>
                  ...
                  {/* Ministry member registration landing — /join/ is the canonical
                      form generated by buildJoinUrl (packages/features/src/qrCode.ts);
                      /register/ stays live for links/QR codes shared before that
                      became the default. Both render the same page. */}
